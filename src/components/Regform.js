            ...
            <div style={{ display: "flex", flexDirection: "column" }}>
              ...
              >
                ...
                <p style={{ fontWeight: "bold", width: "70vw" }}>
                  ...
                  indicate that you cannot relate to the statement at all while
                  5 means that the sentence describes you perfectly.{" "}
                </p>
                <Form.Group id="q1">
                ...
                <Form.Group id="q13">
                  <Form.Label>
                    ...
                    given moment instead of planning a particular daily routine
                  </Form.Label>
                  <br></br>
                  <ToggleButtonGroup
                    name="value13"
