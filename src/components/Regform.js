        ...
        <Card.Body>
          ...
          <Form.Group id="username">
            ...
            <Form.Group id="q12">
              <Form.Label>
                {" "}
                Most of the time, emotions are more important than facts in your
                opinion
              </Form.Label>
              <br></br>
              <ToggleButtonGroup
            ...
            <Form.Group id="q15">
              <Form.Label>
                {" "}
                In an argument with your friend, you think that the fact is less
                important than the feelings of your friend
              </Form.Label>
              <br></br>
              <ToggleButtonGroup
                name="value15"
            ...
            <Form.Group id="q17">
              <Form.Label>
                {" "}
                When knowing that you have the optimal solution, you will still
                consult everyone involved to ensure that everyone is agreeable
              </Form.Label>
              <br></br>
              <ToggleButtonGroup
                name="value17"
            ...
            <Form.Group id="q18">
              <Form.Label>
                {" "}
                You try to avoid conflict at all costs, even when you are in the
                right
              </Form.Label>
              <br></br>
              <ToggleButtonGroup
